<?php include '../app/models/reservationModel.php'; ?>
<?php
  if (empty($_GET['table'])) {
    // Jika nilai 'table' kosong, arahkan ke halaman error
      ...
      <div class="bg-white/40 px-[10px] pt-[18px] pb-[10px] rounded-2xl md:hidden text-center">
        ...
        <form action="" method="post">
          ...
          <div class="my-[20px]">
            ...
            <input readonly id="tableInput" type="hidden" name="table" value="<?= $_GET['table']; ?>">
            <h1 id="tableInput" class="cursor-default text-center bg-transparent border-none text-white font-bold text-[40px]"><?= $_GET['table']; ?></h1>
          </div>
          <button type="submit" name="submitReservation" class="bg-[#184F38] w-[330px] h-[50px] rounded-xl">
