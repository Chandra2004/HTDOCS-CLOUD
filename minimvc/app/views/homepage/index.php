...
<main>
    ...
    <section class="c-hero-center h-screen_4/5x w-full relative onlyMobile:transition-height onlyMobile:duration-300 onlyMobile:delay-300 bg-gray-primary" data-theme="dark" data-module="sal" data-cy="c-hero-center">
        <div class="w-full h-full relative c-hero-center__background-image transition-opacity duration-1000">
            <div class="u-lazy">
                <img src="<?= BASEURL; ?>/img/banner/banner-homepage.png" alt="All Team" class="lazy w-full h-full object-cover" />
        ...
        <div class="container mx-auto mt-2 p-5 w-full h-[95%] overflow-y-auto">
            <ol class="relative border-l border-gray-700">
                <?php foreach ($dataMilestone as $rowMilestone) : ?>
                    <li class="mb-10 ml-6">
                        <span class="absolute flex items-center justify-center w-6 h-6 rounded-full -left-3 ring-8 ring-gray-600 bg-blue-900">
                        ...
                        <div class="p-2 rounded-lg bg-blue-800 bg-opacity-[25%]">
                            <h3 class="mb-1 text-lg font-semibold text-white">
                                <?= $rowMilestone['nama_milestone'] ?>
                            </h3>
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-500">
                                Bekerjasama Sejak <?= $rowMilestone['tanggal_milestone'] ?>
                            </time>
                            <p class="text-base font-normal text-gray-400">
                                <?= $rowMilestone['deskripsi_milestone'] ?>
                            </p>
                        </div>
                    </li>
                <?php endforeach; ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="relative sm:order-2 ">
                    <div class="c-feature-spot-image-single__text">
                        ...
                        <div class="text-center sm:text-left">
                            <a href="<?= BASEURL; ?>/karir" aria-label="Gojek Indonesia" data-gtm="">
                ...
                <div class="relative sm:order-1 ">
                    <div class="c-feature-spot-image-single__image text-center mx-auto sm:absolute">
                        <div class="u-lazy">
                            <picture>
                                <img src="<?= BASEURL; ?>/img/banner/banner-joinus.png" alt="Kami Digital Printing" class="lazy w-[50%] mx-auto md:w-[75%] md:mt-[-32px] lg:w-[50%] lg:mt-[-64px]">
                            </picture>
                            <div class="u-lazy__placeholder"></div>
                        </div>
                    </div>
