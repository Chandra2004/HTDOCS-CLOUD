<?php include '../../../app/models/RepasswordModel.php'; ?>
<?php
    session_start();
        ...
        <section class="pb-6">     
            <form method="post" action="">
                ...
                <div class="flex justify-center">
                    <button type="submit_newPassword" name="submit_newPassword"  class="bg-green-600 hover:bg-green-700 w-full md:w-1/2 mt-2 py-3 rounded-md text-white font-bold hover:text-gray-300">
                        Submit New Password
                    </button>
                </div>
            </form>
