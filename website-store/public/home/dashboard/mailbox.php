                    ...
                    <?php foreach ($dataKarir as $rowKarir) : ?>
                        <tr class="border-b border-zinc-700">
                            <td class="border-r border-zinc-700">
                                <a href="DeleteModel?id=<?= $rowKarir["id"]; ?>" class="flex justify-center items-center">
                            ...
                            <td class="py-2 px-4 text-center lowercase  border-r border-zinc-700"><?= $rowKarir["email_name"]; ?></td>
                    ...
                    <div class="relative w-full max-w-4xl max-h-full">
                        ...
                        <div class="relative rounded-lg shadow bg-gray-700">
                            ...
                            <div class="flex items-center justify-between p-5 border-b rounded-t border-gray-600">
                                <h3 class="text-xl font-medium text-white lowercase">
                                    <?= $rowKarir["email_name"]; ?>
                                </h3>
                                <?php if ($rowKarir['status_name'] == 'unread') : ?>
                                    <a href="updateStatus?id=<?= $rowKarir['id']; ?>" type="button" class="bg-transparent rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center text-white" data-modal-hide="large-modal<?= $rowKarir['id']; ?>">
