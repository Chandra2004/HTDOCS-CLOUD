                    ...
                    <?php foreach ($dataMilestone as $rowMilestone) : ?>
                        <tr class="border-b border-zinc-700">
                            <td class="flex justify-center items-center pt-1 gap-1">
                                <a href="DeleteModel?id=<?= $rowMilestone['id']; ?>" class="flex justify-center items-center">
                        ...
                        <div class="px-6 py-6 lg:px-8">
                            ...
                            <form class="space-y-6" action="" method="post">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name_upmilestone" id="nama_milestone" class="border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white" placeholder="<?= $rowMilestone['name_milestone'] ?>">
                                </div>
                                <div>
                                    <label for="tanggal_milestone" class="block mb-2 text-sm font-medium text-white">Tanggal Pencapaian</label>
                                    <input type="date" name="date_upmilestone" id="tanggal_milestone" class="border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white" placeholder="<?= $rowMilestone['date_milestone'] ?>">
                                </div>
                                <div>
                                    <label for="deskripsi_milestone" class="block mb-2 text-sm font-medium text-white">Deskripsi Pencapaian</label>
                                    <input type="text" name="description_upmilestone" id="deskripsi_milestone" class="border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white" placeholder="<?= $rowMilestone['description_milestone'] ?>">
                                </div>
