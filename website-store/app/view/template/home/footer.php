    ...
    <footer class="bg-gray-primary">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="mb-6 md:mb-0">
                <a href="#" class="flex items-center">
                    <img src="../../app/assets/img/logo/logo.png" class="h-8 mr-3" alt="Logo KAMI Digital Printing Surabaya" />
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="../karir" class="hover:underline ">Informasi</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        ...
                        <li>
                            <a target="_blank" href="https://maps.app.goo.gl/4vbQ8ZYk2cgFFaVcA" class="hover:underline">Lokasi Kami</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="../home" class="hover:underline">Karya Merapi Indonesia™ </a> | All Rights Reserved.
            </span>
        </div>
        </div>
    </footer>
