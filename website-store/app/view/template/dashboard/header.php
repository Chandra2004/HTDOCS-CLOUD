...
<head>
    ...
    <link rel="shortcut icon" href="../../../app/assets/img/logo/favicon.png" type="image/x-icon">
    ...
    <!-- CSS Scrollbar -->
    <link rel="stylesheet" href="../../../app/assets/css/scrollbar.css">
</head>
...
<body class="bg-zinc-800">
    ...
    <nav class="bg-zinc-900  md:px-10">
        <div class="flex flex-wrap items-center justify-between mx-auto p-2 gap-2">
            <div class="flex gap-2">
                ...
                <a href="main" class="flex items-center">
                    <img class="w-28 md:w-30" src="../../../app/assets/img/logo/logo.png" alt="Kami Logo" />
                </a>
            </div>
            <div>
                <div class="flex items-center md:order-2">
                    <button type="button" class="flex mr-3 text-sm bg-zinc-900 rounded-full md:mr-0" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                        ...
                        <img class="w-10 h-10 rounded-full" src="../../../app/assets/users/user-photo/<?= $photo_display ?>" onerror="this.src='../../../app/assets/users/user-photo/error/user.svg';" alt="user photo">
                    </button>
                </div>
            </div>
        </div>
        <div class="z-50 hidden my-4 text-base list-none bg-zinc-900 divide-y px-1 divide-zinc-500 rounded-lg shadow" id="user-dropdown">
            <div class="px-4 py-3">
                <span class="block text-base text-white text-center"><?= $username_display ?></span>
            ...
            <ul class="py-2 text-center" aria-labelledby="user-menu-button">
                <li>
                    <a href="profile" class="block px-4 py-2 text-sm hover:bg-white text-gray-200 hover:text-zinc-900 hover:rounded-lg">Profile</a>
                </li>
                <li>
                    <a href="repassword" class="block px-4 py-2 text-sm hover:bg-white text-gray-200 hover:text-zinc-900 hover:rounded-lg">Ganti Kata sandi</a>
                </li>
                <li>
                    <a href="settings" class="block px-4 py-2 text-sm hover:bg-white text-gray-200 hover:text-zinc-900 hover:rounded-lg">Pengaturan</a>
                </li>
                <li>
        ...
        <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-zinc-900">
                <div>
                    <a href="main" class="flex items-center pl-2.5 mb-5">
                        <img class="w-28 md:w-30 mx-auto" src="../../../app/assets/img/logo/logo.png" alt="Kami Logo" />
                    </a>
                </div>
                <ul class="space-y-1 font-medium">
                    <li>
                        <a href="main" class="flex items-center p-2 text-white rounded-md hover:bg-white group">
                    ...
                    <li>
                        <a href="mailbox" class="flex items-center p-2 text-white rounded-md hover:bg-white group">
                    ...
                    <li>
                        <a href="milestone" class="flex items-center p-2 text-white rounded-md hover:bg-white group">
                            <svg class="flex-shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-zinc-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                    ...
                    <li>
                        <a href="product" class="flex items-center p-2 text-white rounded-md hover:bg-white group">
                            <svg class="flex-shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-zinc-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                    ...
                    <li>
                        <a href="user" class="flex items-center p-2 text-white rounded-md hover:bg-white group">
                            <svg class="flex-shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-zinc-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
