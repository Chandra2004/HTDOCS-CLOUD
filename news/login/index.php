<?php include '../functions/LoginModel.php'; ?>
<?php
...
<head>
    ...
    <link rel="shortcut icon" href="assets/img-internal/logo/favicon.png" type="image/x-icon">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" action="" method="post">
                        <div>
                            ...
                            <input type="email" name="email" id="emus" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Email / Username" required>
                        </div>
                        <div>
                        ...
                        <a href="../index.php" class="text-center block">home</a>
                    </form>
                    <?php if (isset($error)) : ?>
                        <div class="p-4 mt-4 text-sm text-center text-red-800 rounded-lg bg-blue-50" role="alert">
                            <span class="font-medium">Email / Username dan Password tidak cocok</span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
